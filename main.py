...
bot = telebot.TeleBot("8550461086:AAF5HQNs1R7yh2ocfly7eMySUOTyrVavQ2M")
...
def handle_docs_photo(message):
    ...
    class_name, confidence = get_class(model_path="./keras_model.h5", labels_path="labels.txt", image_path=file_name)
    bot.send_message(message.chat.id, f"Class: {class_name}\nConfidence Score: {confidence}")
